<template>
    <section id="projects" class="section-main">
        ...
        <div class="lg:w-4/5 pl-5 lg:mt-0 mt-4">
            <ProjectPanel class="mb-5" v-for="project in projects" 
                :project="project"
            />
        </div>
...
<script setup>
import { ref } from 'vue';
import ProjectPanel from "./Subcomponents/ProjectPanel.vue";
...
const projects = ref([
    {
        ...
        linkText: "To Page",
        linkType: 1,
        secondaryLink: "https://store.steampowered.com/app/3829630/Liturnian/",
    ...
    },
    {
        ...
        linkText: "To Page",
        linkType: 1,
        secondaryLink: "https://naxmaardur.itch.io/professor-bubble",
